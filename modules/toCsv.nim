...
type Scan = object
    ip, hostname, latency: string
    openPorts, closedPorts, filteredPorts: seq[int]
    openCount, closedCount, filteredCount: int

proc toCsv*(ip, hostname, latency: string, openPorts, closedPorts, filteredPorts: seq[int], fileName: var string) =
    var 
        scan: Scan
    ...
    if (not existsFile(fileName)):
        ...
        let header = ["#IP#", "#Hostname#", "#Latency#", "#Open_ports#", "#Open#", "#Closed#", "#Filtered#"]
